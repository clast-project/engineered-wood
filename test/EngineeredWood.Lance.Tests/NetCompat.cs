...
internal static class NetCompat
{
    ...
    /// Matches the BCL behaviour: returns a task that completes once the
    /// process exits (or immediately if it has already exited).
    /// </summary>
    public static Task WaitForExitAsync(this Process process, CancellationToken cancellationToken = default)
    {
        ...
        // Race: process may have exited between HasExited check and Exited
        // subscription. Re-check after subscribing.
